    ...
    def __getitem__(self, idx):
        ...
        if self.dataset_type == "train":
            return torch.tensor(input_ids_source), torch.tensor(
                output_ids), torch.tensor(input_ids_summary), heterograph_source, tokens_positions_source, sents_positions_source, docs_positions_source, heterograph_tgt, tokens_positions_tgt, sents_positions_tgt,article_name, video_file,bounds, video_duration,image_feat,audio_feat,place
        else:
            return torch.tensor(input_ids_source), torch.tensor(
                output_ids), torch.tensor(input_ids_summary), heterograph_source, tokens_positions_source, sents_positions_source, docs_positions_source, heterograph_tgt, tokens_positions_tgt, sents_positions_tgt, tgt,article_name, video_file,bounds, video_duration,image_feat,audio_feat,place
        print("finish")
